   window.onload = function(){
	    $('#example2').bxCarousel({
	        display_num: 10, 
	        move: 1, 
	        prev_image: 'images/06_successful_case_icon_1.png',
	        next_image: 'images/06_successful_case_icon_2.png',
	        auto: true, 
	        controls: true,
	        margin: 0,
	        auto_hover:true,
